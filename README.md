...
| Server | Description |
|--------|-------------|
| [creative-toolkit](https://github.com/jau123/MeiGen-Art) | Turn your AI into a professional creative designer. 1,300+ curated prompts, pro design methodology, 8 purpose-built tools. Supports local ComfyUI and cloud APIs. |
